...
```
python paraphrase.py --method {dummy, roundtrip, intermediate, ncycles} --translators [SPACE SEPARATED TRANSLATORS LIST] --input input/tweets.csv
```
- Evaluate paraphrases:

```
python evaluate.py output/[PARAPHRASES OUTPUT DIRECTORY]
```
